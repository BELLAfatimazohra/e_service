    ...
    <div class="bodyDiv">
        ...
        <div class="options">
            <div class="col1">
                ...
                <a class="opt" href="gestion_professeur/choisir_filiere.php"><button class="btn4"> Gerer les professeurs<svg class="btnsvg" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                ...
                <a class="opt" href="Gestion_modules/choisir_filiere.php"><button class="btn4"> Gerer les modules<svg class="btnsvg" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
