...
<body>
    ...
    <nav id="sidebar" class="sideBarHidden">
        ...
        <ul class="nav-list">
            ...
            <li class="liEmp">
                <a href="javascript:void(0);" onclick="window.location.href='http://localhost/e_service/etudiant/emploi_du_temps_etuds/emploi_du_temps.php'">
                    <div class="group">
            ...
            <li class="liMessage">
                <a href="javascript:void(0);" onclick="window.location.href='http://localhost/e_service/etudiant/messages/message.php'">
                    <div class="group"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
            ...
            <li class="liModules">
                <a href="javascript:void(0);" onclick="window.location.href='http://localhost/e_service/etudiant/modules/choisir_filiere.php'">
