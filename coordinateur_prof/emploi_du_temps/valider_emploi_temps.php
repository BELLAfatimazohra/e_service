...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insérer les données dans la table 'salle'
    ...
    // Boucle sur les heures et les jours pour insérer chaque créneau
    $heures = ['08:00 - 10:00', '10:00 - 12:00', '12:00 - 14:00', '14:00 - 16:00', '16:00 - 18:00'];
    $jours = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'];

    foreach ($heures as $heure) {
        foreach ($jours as $jour) {
            // Exécution de la requête avec les données du formulaire et de l'URL
            $stmt_insert->execute([
                ':Nom_prof' => $prof_name,
                ':nom_jour' => $jour,
                ':Nom_salle' => $nom_salle,
                ':temps' => $heure,
                ':type_sceance' => $type_cours,
                ':bloc' => $bloc,
